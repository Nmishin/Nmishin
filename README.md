...
- [leaseweb/terraform-provider-leaseweb](https://github.com/leaseweb/terraform-provider-leaseweb) ([v1.31.1](https://github.com/leaseweb/terraform-provider-leaseweb/releases/tag/v1.31.1), 3 days ago) - The Leaseweb terraform provider plugin
- [tofuutils/pre-commit-opentofu](https://github.com/tofuutils/pre-commit-opentofu) ([v2.4.1](https://github.com/tofuutils/pre-commit-opentofu/releases/tag/v2.4.1), 6 days ago) - pre-commit git hooks to take care of OpenTofu configurations
