...
- [tofuutils/pre-commit-opentofu](https://github.com/tofuutils/pre-commit-opentofu) ([v2.3.0](https://github.com/tofuutils/pre-commit-opentofu/releases/tag/v2.3.0), 2 days ago) - pre-commit git hooks to take care of OpenTofu configurations
- [tofuutils/tenv](https://github.com/tofuutils/tenv) ([v4.11.1](https://github.com/tofuutils/tenv/releases/tag/v4.11.1), 3 days ago) - OpenTofu / Terraform / Terragrunt / Terramate and Atmos version manager
