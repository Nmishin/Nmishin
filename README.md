...
- [tofuutils/pre-commit-opentofu](https://github.com/tofuutils/pre-commit-opentofu) ([v2.4.2](https://github.com/tofuutils/pre-commit-opentofu/releases/tag/v2.4.2), 1 day ago) - pre-commit git hooks to take care of OpenTofu configurations
- [tofuutils/tenv](https://github.com/tofuutils/tenv) ([v4.14.8](https://github.com/tofuutils/tenv/releases/tag/v4.14.8), 3 days ago) - OpenTofu / Terraform / Terragrunt / Terramate and Atmos version manager
