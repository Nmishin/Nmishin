...
- [leaseweb/terraform-provider-leaseweb](https://github.com/leaseweb/terraform-provider-leaseweb) ([v1.31.1](https://github.com/leaseweb/terraform-provider-leaseweb/releases/tag/v1.31.1), 6 days ago) - The Leaseweb terraform provider plugin
- [tofuutils/pre-commit-opentofu](https://github.com/tofuutils/pre-commit-opentofu) ([v2.4.1](https://github.com/tofuutils/pre-commit-opentofu/releases/tag/v2.4.1), 1 week ago) - pre-commit git hooks to take care of OpenTofu configurations
- [tofuutils/tenv](https://github.com/tofuutils/tenv) ([v4.12.2](https://github.com/tofuutils/tenv/releases/tag/v4.12.2), 1 month ago) - OpenTofu / Terraform / Terragrunt / Terramate and Atmos version manager
